...
public class ResourceRegistryStore {
	...
	public static final String IMG_CREDENTIAL_ISSUE_16x16						= "credential_issue_16x16"; //$NON-NLS-1$
	public static final String IMG_CREDENTIAL_ISSUE_64x64                       = "credential_issue_64x64"; //$NON-NLS-1$
	public static final String IMG_CREDENTIALS_16x16                            = "credentials_16x16"; //$NON-NLS-1$
	public static final String IMG_CREDENTIALS_64x45                            = "credentials_64x45"; //$NON-NLS-1$
	...
	private void initializeImages() {
		...
		imageRegistry.put(IMG_CREDENTIAL_ISSUE_16x16, getImageDescriptorFromPlugin("icons/credential_add_16x16.png")); //$NON-NLS-1$ //$NON-NLS-2$
		imageRegistry.put(IMG_CREDENTIAL_ISSUE_64x64, getImageDescriptorFromPlugin("icons/credential_add_64x64.png")); //$NON-NLS-1$ //$NON-NLS-2$
		imageRegistry.put(IMG_CREDENTIALS_16x16, getImageDescriptorFromPlugin("icons/credentials_16x16.png")); //$NON-NLS-1$ //$NON-NLS-2$
		imageRegistry.put(IMG_CREDENTIALS_64x45, getImageDescriptorFromPlugin("icons/credentials_64x45.png")); //$NON-NLS-1$ //$NON-NLS-2$
