...
import eu.abc4trust.ri.service.revocation.RevocationServiceUtilities;
...
public class ITRevocation {
    ...
    public void verifyPresentationTokenWithRevocation() throws Exception {
      ...
      initVerifierAndUser(CryptoEngine.BRIDGED, CryptoEngine.IDEMIX);
      ...
      while (true) {
          ...
          if(im_and_boolean.lastMessage) {
            System.out.println("LastMessage ON SERVER ! " + service_im.getContext() + " ; " + im_and_boolean.issuanceLogEntryURI + " : " + im_and_boolean.im.getAny() );
      ...
      runPresenationWithRevokableCredential(true);
      ...
      if(attribute!=null) {
        ...
        riFromRevocation = revokeResource.post(RevocationInformation.class, of.createAttribute(attribute));
      ...
      runPresenationWithRevokableCredential(false);
