...
public class InspectorHelperTest {
    ...
    private void test_init(String test_name, boolean clearFiles, URI[] inspectorKeyUIDs) throws Exception {
        ...
        InspectorHelper.initInstance(inspectorStorageAndResourcesPrefix + "storage/", inspectorStorageAndResourcesPrefix + "resources/", null, inspectorKeyUIDs, credSpecResourceList);
    }
