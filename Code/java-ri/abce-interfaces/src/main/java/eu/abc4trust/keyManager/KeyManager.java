...
public interface KeyManager {
    ...
    /**
     * This method retrieves and returns the latest revocation information for the given Revocation Authority
     * parameters rapuid. 
     *      
     * @param rapuid
     * @return
    ...
    /**
     * This method returns the Credential Specification with the given unique
     * identifier credspecuid, or returns nothing (null) if no specification can
     * be obtained in a trusted way.
     * 
     * @param credspec
     * @return
     * @throws KeyManagerException
     */
    CredentialSpecification getCredentialSpecification(URI credspec)
            throws KeyManagerException;

    /**
     * This method stores the Credential specification with the given unique
     * identifier uid in a trusted way.
     * 
     * @param uid
     ...
     * @throws KeyManagerException
     */
    boolean storeCredentialSpecification(URI uid,
            CredentialSpecification credentialSpecification)
                    throws KeyManagerException;

    /**
     * This method stores the system parameters. There is only one set of valid
     * system parameters at any given time for a given incarnation of the ABCE.
     * 
    ...
    /**
     * This method returns the system parameters. There is only one set of valid
     * system parameters at any given time for a given incarnation of the ABCE.
     * 
     * @throws KeyManagerException
     * 
