...
public class IssuanceHelper {
    ...
    public CredentialDescription issueCredential(Injector issuerInjector,
        ...
        // Step 1. Load the credential specification into the keystore.
        ...
        // Step 1b. Load inspectors
        {
            ...
            userKeyManager.storeInspectorPublicKey(inspector1, ipk1);
        }
        {
            ...
            userKeyManager.storeInspectorPublicKey(inspector2, ipk2);
        }
