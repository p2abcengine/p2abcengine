...
public class HardwareSmartcardTest {
    ...
    public void InitializeCard() throws UnsupportedEncodingException{
        ...
        assertEquals(s.addIssuerParameters(pin, rootKey, IssuerURINo1, getCredentialBases()), SmartcardStatusCode.OK);
        ...
        int minAttendance = 2;
        assertEquals(s.addIssuerParametersWithAttendanceCheck(pin, rootKey, IssuerURINo2, keyIDForSecondSignKey, getCredentialBases(), cvk, minAttendance), SmartcardStatusCode.OK);
    ...
    public void testBlobStore(){
    	...
    	SmartcardBlob blob = new SmartcardBlob();
    	String toBlob = new String("Jeg er en blob!");
    	try {
    ...
    public void testAuthentication(){
    	System.out.println("n: " +rootKey.getN());
    	
    	HardwareSmartcard s = getSmartcard();
    	byte[] data = new byte[256];
    	assertEquals(s.authenticateData(data, rootKey, 0, 0x00), SmartcardStatusCode.OK);
    }
