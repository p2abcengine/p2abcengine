...
public class HotelBookingTest {
    ...
    private void runTestWithEngines(Injector governmentInjector,
        ...
        IssuancePolicy creditCardIssuancePolicy = (IssuancePolicy) XmlUtils
                .getObjectFromXML(
                        this.getClass().getResourceAsStream(
                                ISSUANCE_POLICY_REVOCABLE_CREDIT_CARD), true);
        ...
        CredentialSpecification credentialSpecificationCreditcard = (CredentialSpecification) XmlUtils
                .getObjectFromXML(
                        this.getClass().getResourceAsStream(
