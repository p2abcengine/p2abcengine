...
public class StaticGroupParameters {
	...
	//public static final BigInteger p = new BigInteger("");
  	...
  	public static final URI sysParamsUri = URI.create(IdemixConstants.groupParameterId);//URI.create("UProve:Recommended:Parameters:OID:1.3.6.1.4.1.311.75.1.1.1");
