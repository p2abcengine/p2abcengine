...
public class ITRevocationAuthorityParameters extends ITAbstract {
    static ObjectFactory of = new ObjectFactory();

    @Test
    public void setupRevocationAuthorityParameters() throws Exception {
        ...
        RevocationAuthorityParameters revocationAuthorityParameters = revocationServiceFactory
