...
public class ITGenerateNonRevocationEvidenceUpdate extends ITAbstract {

    static ObjectFactory of = new ObjectFactory();

    @Test
    public void generateNonRevocationEvidenceUpdate() throws Exception {
        ...
        NonRevocationEvidenceUpdate nre = revocationServiceFactory
        		.generateNonRevocationEvidenceUpdate(revocationAuthorityParametersUid, epoch);
        assertNotNull(nre);
    }
