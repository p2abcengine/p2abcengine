...
public class ITGetRevocationInformation extends ITAbstract {

    static ObjectFactory of = new ObjectFactory();

    @Test
    public void getRevocationInformation() throws Exception {
        ...
        RevocationInformation revocationInformation = revocationServiceFactory
        		.getRevocationInformation(revocationAuthorityParametersUid);
