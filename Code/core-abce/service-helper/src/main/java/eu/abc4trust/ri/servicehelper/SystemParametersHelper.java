...
public class SystemParametersHelper {
  private static final Logger logger = Logger.getLogger(SystemParametersHelper.class.toString());

  public static SystemParameters checkAndLoadSystemParametersIfAbsent(KeyManager keyManager,
  ...
  /**
   * Check if system parameters are available in the 'file system' Return true if the system
   * parameters are loaded from disk. And false otherwise.
   * 
   * @param keyManager
   * @return
  ...
  private static SystemParameters checkIfSystemParametersAreLoaded(KeyManager keyManager)
      throws KeyManagerException {
