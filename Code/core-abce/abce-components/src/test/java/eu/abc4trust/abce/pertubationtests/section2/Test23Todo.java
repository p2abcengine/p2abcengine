...
/**
 * Pertubation tests 2.2.3, 
 */
public class Test23Todo {
    ...
    private static final Logger logger = java.util.logging.Logger.getLogger("Section 2.2.3 log");
...
//	private RevocationProxyAuthority revocationProxyAuthority = null;
	...
	public static void setupLogger() throws SecurityException, IOException {
		Handler fh = new FileHandler("Section-2.2.3.log");
...
/*		revocationInjector = Guice
	...
	public void performTest(SystemParameters syspars) throws Exception{
    	try{
    		...
    		try{
    			...
    			logger.info("Failed to create IssuerParameters using modified system parameters");
    			assertTrue(false);
    		}
