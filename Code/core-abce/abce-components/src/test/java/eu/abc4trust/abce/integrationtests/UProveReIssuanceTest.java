...
public class UProveReIssuanceTest {
	...
	public void testReIssuance() throws Exception{
        ...
        // Get Injectors,
        Injector revocationInjector = Guice.createInjector(IntegrationModuleFactory.newModule(new Random(1231), CryptoEngine.IDEMIX, uproveUtils.getUserServicePort()));
        ...
        Injector fakeInjector = Guice.createInjector(IntegrationModuleFactory.newModule(new Random(1231), CryptoEngine.IDEMIX, uproveUtils.getUserServicePort()));
        ...
        System.out.println("Cred Desc: " + XmlUtils.toXml(of.createCredentialDescription(c.getCredentialDescription())));
        System.out.println("CryptoParams size: "+ c.getCryptoParams().getAny().size());
        System.out.println("Arraylist size: "+ ((ArrayList<?>)c.getCryptoParams().getAny().get(0)).size());
