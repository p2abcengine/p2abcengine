...
public class UProveReIssuanceTest {
  ...
  /**
   * Tests the concept of re-issuance. There is by default 5 tokens which can 
   * be used, so we use 11 in order to test the re-issuance twice.   
   * @throws Exception
   */
  ...
  public void patraPilotUProveTest() throws Exception {
    ...
    //11 should ensure that the credential is re-issued twice.
    for(int i = 0; i < 11; i++){
