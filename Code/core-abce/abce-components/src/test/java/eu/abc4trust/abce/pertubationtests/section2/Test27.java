...
public class Test27 {
    ...
    private static final Logger logger = java.util.logging.Logger.getLogger("Section 2.2.7 log");
	...
	public static void setupLogger() throws SecurityException, IOException {
		Handler fh = new FileHandler("Section-2.2.7.log");
	...
	@Test
	public void runTestNullUID() throws Exception{
    	try{
    		logger.info("Running test with null as UID");    		
            ...
            RevocationAuthorityParameters revocationAuthorityParameters = revocationEngine
                    .setupRevocationAuthorityParameters(1024,
                    		Helper.getRevocationTechnologyURI("cl"), null, revocationInfoReference,
	...
	@Test
	public void runTestNullCrypto() throws Exception{
    	try{
    		logger.info("Running test with null as cryptomechanism");    		
