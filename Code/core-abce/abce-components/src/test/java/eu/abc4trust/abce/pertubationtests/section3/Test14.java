...
public class Test14 {
    ...
    private static final Logger logger = java.util.logging.Logger.getLogger("Section 3.1.4 log");
	...
	public static void setupLogger() throws SecurityException, IOException {
		Handler fh = new FileHandler("Section-3.1.4.log");
...
//		inspectorInjector.getInstance(KeyManager.class).storeSystemParameters(syspars);
  ...
  //              idcardCredSpec.getSpecificationUID(), idcardCredSpec);
	...
	@Test
	public void runTestHijackContext() throws Exception{
    	try{
    		...
    		URI context = runTest(idcardIssuancePolicy, null);
