...
public class CredentialManagerImpl implements CredentialManager {
    ...
    private Object loadObject(URI uid) throws CredentialManagerException {
        ...
        try {
            ...
            if (tokenBytes == null) {
                throw new CredentialManagerException("Object with UID: \""
                        + uid
                        + "\" is not in storage");
            }
    ...
    private void storeObject(Object o, URI uid)
    ...
    public void storeSecretKey(
            URI revocationAuthorityKeyUID, SecretKey secretKey)
                    throws CredentialManagerException {
    ...
    @Override
    public void storeRevocationHistory(URI historyUID,
            RevocationHistory revHistory) throws CredentialManagerException {
        this.storeObject(revHistory, historyUID);
    }

    @Override
    public void addRevocationLogEntry(URI logEntryUID,
            RevocationLogEntry revLogEntry) throws CredentialManagerException {
    ...
    public void deleteRevocationLogEntry(URI logEntryUID)
            throws CredentialManagerException {
        try {
            RevocationLogEntry revLogEntry = this
                    .getRevocationLogEntry(logEntryUID);
            if (revLogEntry != null) {
