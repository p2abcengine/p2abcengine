...
public class IdemixCryptoEngineIssuerImpl implements CryptoEngineIssuer {
    ...
    public SystemParameters setupSystemParameters(int keyLength, URI cryptographicMechanism) {
        ...
        ret.getAny().add(XMLSerializer.getInstance().serializeAsElement(sp));
        ret.getAny().add(XMLSerializer.getInstance().serializeAsElement(gp));
        //ret.getAny().add(sp);
        //ret.getAny().add(gp);
    ...
    public IssuanceMessageAndBoolean initIssuanceProtocol(IssuancePolicy ip,
        ...
        TimingsLogger.logTiming("IdemixCryptoEngineIssuerImpl.initIssuanceProtocol", true);
        ...
        TimingsLogger.logTiming("IdemixCryptoEngineIssuerImpl.initIssuanceProtocol", false);
    ...
    public IssuanceMessageAndBoolean issuanceProtocolStep(IssuanceMessage m)
        ...
        TimingsLogger.logTiming("IdemixCryptoEngineIssuerImpl.issuanceProtocolStep", true);
        ...
        TimingsLogger.logTiming("IdemixCryptoEngineIssuerImpl.issuanceProtocolStep", false);
        return imab;
    }
