...
package eu.abc4trust.cryptoEngine.revocation;
...
public interface CryptoEngineRevocation {
     ...
     * uid as well as the endpoints where Users and Verifiers can obtain the
     * latest revocation information (inforef), initial non-revocation evidence
     * (evidenceref), and updates to their non-revocation evidence (updref).
     * 
     * @param keyLength
