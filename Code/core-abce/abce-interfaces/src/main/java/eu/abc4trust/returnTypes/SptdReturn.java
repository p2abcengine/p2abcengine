...
// eu.abc4trust.ui.idSelection.IdentitySelection.selectPresentationTokenDescription
@XmlRootElement(name="SptdReturn", namespace = "http://abc4trust.eu/wp2/abcschemav1.0") 
@XmlAccessorType(XmlAccessType.FIELD)
public class SptdReturn {
  /**
   ...
   * pseudonymChoice[chosenPresentationToken][j].contains(chosenPseudonyms[j])
   */
  public List<URI> chosenPseudonyms;
  /**
   * Chosen inspectors: where
   * inspectorChoice[chosenPresentationToken][j].contains(chosenInspectors[j])
   */
  public List<URI> chosenInspectors;

  public SptdReturn(int chosenPresentationToken, Map<URI, PseudonymMetadata> metadataToChange,
      List<URI> chosenPseudonyms, List<URI> chosenInspectors) {
  ...
  public String toString() {
    return "SptdReturn [chosenPresentationToken=" + chosenPresentationToken + ", metadataToChange="
