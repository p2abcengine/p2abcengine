...
namespace UProveCrypto
{
    ...
    /// </summary>
    public static class ECParameterSets
    {
        /// <summary> OID for P-256</summary>
        public const string ParamSet_EC_P256_V1Name = "1.3.6.1.4.1.311.75.1.2.1";
        /// <summary> OID for P-384</summary>
        public const string ParamSet_EC_P384_V1Name = "1.3.6.1.4.1.311.75.1.2.2";
        /// <summary> OID for P-521</summary>
        public const string ParamSet_EC_P521_V1Name = "1.3.6.1.4.1.311.75.1.2.3";

        static ECParameterSets()
        {
            
            ECParameterSets.ParamSet_EC_P256_V1 = new ParameterSet(
                ECParameterSets.ParamSet_EC_P256_V1Name,
                P256.Gq,
                P256.IssuerGenerators,
                P256.Gd);

            ECParameterSets.ParamSet_EC_P384_V1 = new ParameterSet(
                ECParameterSets.ParamSet_EC_P384_V1Name,
                P384.Gq,
                P384.IssuerGenerators,
                P384.Gd);


            ECParameterSets.ParamSet_EC_P521_V1 = new ParameterSet(
                ECParameterSets.ParamSet_EC_P521_V1Name,
                P521.Gq,
                P521.IssuerGenerators,
                P521.Gd);
        }
        
        /// <summary>Recommended EC parameter set P-256.</summary>
        public static ParameterSet ParamSet_EC_P256_V1 { get; private set; }
        /// <summary>Recommended EC parameter set P-384.</summary>
        public static ParameterSet ParamSet_EC_P384_V1 { get; private set; }
        /// <summary>Recommended EC parameter set P-521.</summary>
        public static ParameterSet ParamSet_EC_P521_V1 { get; private set; }
...
static readonly byte[] a = {
0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x01,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc
};
static readonly byte[] b = {
...
static readonly byte[] h = {
0x01
};

// g
static readonly byte[] g_x = {
0x6b, 0x17, 0xd1, 0xf2, 0xe1, 0x2c, 0x42, 0x47,
0xf8, 0xbc, 0xe6, 0xe5, 0x63, 0xa4, 0x40, 0xf2,
0x77, 0x03, 0x7d, 0x81, 0x2d, 0xeb, 0x33, 0xa0,
0xf4, 0xa1, 0x39, 0x45, 0xd8, 0x98, 0xc2, 0x96
};
static readonly byte[] g_y = {
...
0x79, 0xcc, 0xd7, 0x23, 0x3f, 0xbb, 0xa6, 0x36
            ...
            private static readonly ECGroup ecGroup = ECGroup.CreateECGroup(p, a, b, g_x, g_y, n, ParamSet_EC_P256_V1Name, "P-256");

            internal static readonly Group Gq = ecGroup;
                
            internal static readonly GroupElement Gd = ecGroup.CreateGroupElement(gd_x, gd_y);

            internal static readonly GroupElement[] IssuerGenerators = {
                ecGroup.CreateGroupElement(g1_x, g1_y),
                ecGroup.CreateGroupElement(g2_x, g2_y),
                ecGroup.CreateGroupElement(g3_x, g3_y),
                ecGroup.CreateGroupElement(g4_x, g4_y),
                ecGroup.CreateGroupElement(g5_x, g5_y),
                ecGroup.CreateGroupElement(g6_x, g6_y),
                ecGroup.CreateGroupElement(g7_x, g7_y),
                ecGroup.CreateGroupElement(g8_x, g8_y),
                ecGroup.CreateGroupElement(g9_x, g9_y),
                ecGroup.CreateGroupElement(g10_x, g10_y),
                ecGroup.CreateGroupElement(g11_x, g11_y),
                ecGroup.CreateGroupElement(g12_x, g12_y),
                ecGroup.CreateGroupElement(g13_x, g13_y),
                ecGroup.CreateGroupElement(g14_x, g14_y),
                ecGroup.CreateGroupElement(g15_x, g15_y),
                ecGroup.CreateGroupElement(g16_x, g16_y),
                ecGroup.CreateGroupElement(g17_x, g17_y),
                ecGroup.CreateGroupElement(g18_x, g18_y),
                ecGroup.CreateGroupElement(g19_x, g19_y),
                ecGroup.CreateGroupElement(g20_x, g20_y),
                ecGroup.CreateGroupElement(g21_x, g21_y),
                ecGroup.CreateGroupElement(g22_x, g22_y),
                ecGroup.CreateGroupElement(g23_x, g23_y),
                ecGroup.CreateGroupElement(g24_x, g24_y),
                ecGroup.CreateGroupElement(g25_x, g25_y),
                ecGroup.CreateGroupElement(g26_x, g26_y),
                ecGroup.CreateGroupElement(g27_x, g27_y),
                ecGroup.CreateGroupElement(g28_x, g28_y),
                ecGroup.CreateGroupElement(g29_x, g29_y),
                ecGroup.CreateGroupElement(g30_x, g30_y),
                ecGroup.CreateGroupElement(g31_x, g31_y),
                ecGroup.CreateGroupElement(g32_x, g32_y),
                ecGroup.CreateGroupElement(g33_x, g33_y),
                ecGroup.CreateGroupElement(g34_x, g34_y),
                ecGroup.CreateGroupElement(g35_x, g35_y),
                ecGroup.CreateGroupElement(g36_x, g36_y),
                ecGroup.CreateGroupElement(g37_x, g37_y),
                ecGroup.CreateGroupElement(g38_x, g38_y),
                ecGroup.CreateGroupElement(g39_x, g39_y),
                ecGroup.CreateGroupElement(g40_x, g40_y),
                ecGroup.CreateGroupElement(g41_x, g41_y),
                ecGroup.CreateGroupElement(g42_x, g42_y),
                ecGroup.CreateGroupElement(g43_x, g43_y),
                ecGroup.CreateGroupElement(g44_x, g44_y),
                ecGroup.CreateGroupElement(g45_x, g45_y),
                ecGroup.CreateGroupElement(g46_x, g46_y),
                ecGroup.CreateGroupElement(g47_x, g47_y),
                ecGroup.CreateGroupElement(g48_x, g48_y),
                ecGroup.CreateGroupElement(g49_x, g49_y),
                ecGroup.CreateGroupElement(g50_x, g50_y),
                ecGroup.CreateGroupElement(gt_x, gt_y)
                };
...
// gd (counter = 2)
static readonly byte[] gd_x = {
0xed, 0x14, 0xac, 0x90, 0x7c, 0xad, 0xce, 0xde,
0xdd, 0xbb, 0x77, 0x2a, 0x2c, 0x20, 0x96, 0x04,
0xfa, 0xd1, 0xb4, 0x3b, 0xd8, 0x5a, 0xcf, 0x2d,
0xf5, 0x0e, 0x84, 0x8b, 0xd9, 0xaa, 0x5b, 0x99,
0xb6, 0x5b, 0x6a, 0x87, 0xdb, 0xea, 0xc9, 0x0f,
0x33, 0x01, 0xe8, 0xc9, 0xd4, 0x5b, 0x03, 0x7f
};
static readonly byte[] gd_y = {
0x60, 0x44, 0x88, 0x78, 0xdc, 0x34, 0xae, 0x65,
0x67, 0x3d, 0x98, 0x2e, 0xf3, 0x00, 0xa5, 0x65,
0xac, 0x0b, 0x46, 0x51, 0x0b, 0xb9, 0x62, 0xf1,
0xa0, 0x0c, 0x45, 0x9d, 0xc9, 0x69, 0xe0, 0x49,
0xad, 0xd2, 0x11, 0x21, 0x06, 0x07, 0xdb, 0x5a,
0x06, 0xf1, 0x02, 0x50, 0x50, 0x67, 0xf5, 0x98
};

            private static readonly ECGroup ecGroup = ECGroup.CreateECGroup(p, a, b, g_x, g_y, n, ParamSet_EC_P384_V1Name, "P-384");
...
// gd (counter = 2)
static readonly byte[] gd_x = {
0x01, 0x5f, 0x3a, 0xe2, 0xee, 0x57, 0x67, 0x1e,
0x1b, 0xdc, 0x87, 0x04, 0x7f, 0x34, 0xcb, 0xe0,
0xaa, 0xbc, 0x69, 0x3f, 0x46, 0x3b, 0x13, 0xd4,
0x2d, 0xf6, 0xfd, 0x10, 0xf8, 0x6c, 0xc7, 0xb4,
0xb4, 0xb9, 0x99, 0xc9, 0xc3, 0x8b, 0xde, 0xfa,
0x8e, 0x13, 0xc7, 0x01, 0x74, 0xf1, 0xbe, 0x79,
0xf8, 0xe9, 0x34, 0xa3, 0xa0, 0x18, 0x03, 0x07,
0x3b, 0x34, 0x04, 0x6b, 0x8d, 0x8f, 0xfc, 0x79,
0x93, 0x42
};
static readonly byte[] gd_y = {
0xf0, 0x98, 0x4a, 0xc4, 0x3d, 0x1a, 0x34, 0xd5,
0x21, 0x43, 0xf0, 0x9a, 0xbd, 0x17, 0x46, 0xbc,
0xd1, 0x1e, 0x54, 0x95, 0xa0, 0x96, 0xe3, 0x07,
0xd1, 0xab, 0x21, 0x64, 0x8b, 0x11, 0x18, 0xc2,
0x9c, 0x20, 0x1f, 0x29, 0xd0, 0x85, 0xd6, 0xa8,
0xa4, 0xda, 0x6c, 0xf7, 0x60, 0xc8, 0x18, 0xdc,
0xdc, 0x4e, 0xde, 0x01, 0xb4, 0x11, 0x06, 0x5c,
0xac, 0x92, 0xee, 0xa1, 0xcc, 0x51, 0xbd, 0xaf,
0xb2
};

            private static readonly ECGroup ecGroup = ECGroup.CreateECGroup(p, a, b, g_x, g_y, n, ParamSet_EC_P521_V1Name, "P-521");
